...
#ifndef __LASERSENSOR_3D_SERVER_H_
#define __LASERSENSOR_3D_SERVER_H_
...
class LaserSensor3DServer : public Server
{
public:
	//Pointer to the laser we want to serve
	LaserSensor3DServer(LaserSensor3D* las,string name):Server(name){laser=las;}
