...
#ifndef __WHEELEDBASED_SERVER_H_
#define __WHEELEDBASED_SERVER_H_
...
class WheeledBaseServer : public Server
{
public:
	//Pointer to the robot we want to serve
	WheeledBaseServer(WheeledBase* rob,string name):Server(name){robot=rob;}
