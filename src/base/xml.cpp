...
// Content class
#ifdef XML_USE_STL
XMLContent& XMLElement :: AddContent(const char* t,int InsertBeforeElement)
	{
	XMLContent x(this,InsertBeforeElement,t);
...
int XMLElement :: AddContent(const char* t,int InsertBeforeElement)
	{
