...
// v.0x156
// revision 9 - 8 - 2009
#define XML_VERSION 0x156
#define XML_VERSION_REVISION_DATE "09-08-2009"
...
class XMLElement
	...
	public:
		...
		XMLContent& AddContent(const char*,int);
...
class XMLContent
	...
	public:
		...
		// constructors/destructor
		XMLContent(XMLElement* p = 0,int ElementPosition = -1,const char* ht = 0,int NoDecode = 0);
		operator const char*();
		size_t GetValue(char*,int NoDecode = 0) const; 
		void SetValue(const char*,int NoDecode = 0);
///////////////////////////////////////////////// PROYECTO FRAN ///////////////////////
